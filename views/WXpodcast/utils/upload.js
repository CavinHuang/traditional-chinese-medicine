class Wechat {
   ...
   */
  static chooseImage(count = 1, sizeType = ['original', 'compressed'], sourceType = ['album', 'camera']) {
    return new Promise((resolve, reject) => wx.chooseMedia({ count, sizeType, sourceType, success: resolve, fail: reject }));
  }
  /**
